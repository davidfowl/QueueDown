...
public static class ProcessUtil
{
    ...
    public static async Task<(string StandardOutput, string StandardError, int ExitCode)> RunAsync(
        string filename,
        string? arguments,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var processLifetimeTask = new TaskCompletionSource<(string, string, int ExitCode)>();
        ...
        process.Exited += (_, e) =>
        {
            ...
            else
            {
                ...
                processLifetimeTask.TrySetResult(new(outputBuilder.ToString(), errorBuilder.ToString(), process.ExitCode));
            }
        };
